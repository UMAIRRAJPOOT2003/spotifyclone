...
.artist__header:before {
  ...
  z-index: 0;
  opacity: 0.15;
  background-image: url('./images/Todays Top Hits.jpg');
  background-repeat: no-repeat;
  background-size: cover;
    ...
    <div class="artist__header">
      ...
      <div class="artist__info">
        ...
        <div class="profile__img">
          ...
          <img src="./images/Todays Top Hits.jpg" alt="G-Eazy" />
        ...
        <div class="artist__info__meta">
          ...
          <div class="artist__info__name">Olivia Rodrigo</div>
            ...
            <div class="overview__artist">
              ...
              <div class="latest-release">
                ...
                <div class="latest-release__art">
                  ...
                  <img src="./images/olvia2.jpeg" alt="When It's Dark Out" />

                </div>

                <div class="latest-release__song">

                  <div class="latest-release__song__title">Vampire (Track Commentary)</div>
              ...
              <div class="album">
                ...
                <div class="album__info">
                  ...
                  <div class="album__info__meta">
                    ...
                    <div class="album__name">Guts</div>
    ...
    $row = mysqli_fetch_assoc($result); 
                           ...
                           echo'<div class="track">';
                                        ...
                                        echo' </div>';
                                         ...
                                         echo "<div><button type='submit' class='btn btn-primary audio-control pause' data-audio='/audio/intro.mp3' name='pause' style='top:7px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                         onmouseover=\"this.style.backgroundColor='red'\"
                                         onmouseout=\"this.style.backgroundColor='white'\">Pause</button></div>";
                                 
                                 echo "<div><button type='submit' class='btn btn-primary audio-control play' data-audio='/audio/intro.mp3' name='play' style='left: -80px;top:-25px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                       ...
                       $row = mysqli_fetch_assoc($result); 
                           ...
                           echo'<div class="track">';
                                        ...
                                        echo' </div>';
                                         ...
                                         echo'<div class="track__explicit">';
                                         echo "<div><button type='submit' class='btn btn-primary audio-control pause' data-audio='/audio/memyself.mp3' name='pause' style='top:7px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                         onmouseover=\"this.style.backgroundColor='red'\"
                                         onmouseout=\"this.style.backgroundColor='white'\">Pause</button></div>";
                                 
                                 echo "<div><button type='submit' class='btn btn-primary audio-control play' data-audio='/audio/memyself.mp3' name='play' style='left: -80px;top:-25px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                         onmouseover=\"this.style.backgroundColor='darkgreen'\"
                                         onmouseout=\"this.style.backgroundColor='white'\">Play</button></div>";
                                      ...
                                      echo'<div class="track">';
                                                   ...
                                                   echo' </div>';
                                                    ...
                                                    echo'<div class="track__explicit">';
                                                    echo "<div><button type='submit' class='btn btn-primary audio-control pause' data-audio='/audio/sweater.mp3' name='pause' style='top:7px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                                    onmouseover=\"this.style.backgroundColor='red'\"
                                                    onmouseout=\"this.style.backgroundColor='white'\">Pause</button></div>";
                                            
                                            echo "<div><button type='submit' class='btn btn-primary audio-control play' data-audio='/audio/sweater.mp3' name='play' style='left: -80px;top:-25px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                                    onmouseover=\"this.style.backgroundColor='darkgreen'\"
                                                    onmouseout=\"this.style.backgroundColor='white'\">Play</button></div>";
