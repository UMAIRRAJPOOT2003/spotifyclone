...
.artist__header:before {
  ...
  z-index: 0;
  opacity: 0.15;
  background-image: url('./images/Rock Classics.jpg');
  background-repeat: no-repeat;
  background-size: cover;
    ...
    <div class="artist__header">
      ...
      <div class="artist__info">
        ...
        <div class="profile__img">
          ...
          <img src="./images/edsheeran.jpg" alt="G-Eazy" />
        ...
        <div class="artist__info__meta">
          ...
          <div class="artist__info__name">Ed Sheeran</div>
      ...
      <div class="artist__listeners">
        ...
        <div class="artist__listeners__count">22,212,567</div>
            ...
            <div class="overview__artist">
              ...
              <div class="latest-release">
                ...
                <div class="latest-release__art">
                  ...
                  <img src="./images/edsheeranalbums.jpg" alt="When It's Dark Out" />

                </div>

                <div class="latest-release__song">

                  <div class="latest-release__song__title">Blood Stream (Track Commentary)</div>
    ...
    $row = mysqli_fetch_assoc($result); 
                           ...
                           echo'<div class="track">';
                                        ...
                                        echo' </div>';
                                         ...
                                         echo "<div><button type='submit' class='btn btn-primary audio-control pause' data-audio='/audio/mess.mp3' name='pause' style='top:7px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                         onmouseover=\"this.style.backgroundColor='red'\"
                                         onmouseout=\"this.style.backgroundColor='white'\">Pause</button></div>";
                                 
                                 echo "<div><button type='submit' class='btn btn-primary audio-control play' data-audio='/audio/mess.mp3' name='play' style='left: -80px;top:-25px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                       ...
                       $row = mysqli_fetch_assoc($result); 
                           ...
                           echo'<div class="track">';
                                        ...
                                        echo' </div>';
                                         ...
                                         echo'<div class="track__explicit">';
                                         echo "<div><button type='submit' class='btn btn-primary audio-control pause' data-audio='/audio/imamess.mp3'' name='pause' style='top:7px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                         onmouseover=\"this.style.backgroundColor='red'\"
                                         onmouseout=\"this.style.backgroundColor='white'\">Pause</button></div>";
                                 
                                 echo "<div><button type='submit' class='btn btn-primary audio-control play' data-audio='/audio/imamess.mp3' name='play' style='left: -80px;top:-25px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                         onmouseover=\"this.style.backgroundColor='darkgreen'\"
                                         onmouseout=\"this.style.backgroundColor='white'\">Play</button></div>";
                                      ...
                                      echo'<div class="track">';
                                                   ...
                                                   echo' </div>';
                                                    ...
                                                    echo'<div class="track__explicit">';
                                                    echo "<div><button type='submit' class='btn btn-primary audio-control pause' data-audio='/audio/nightwemet.mp3' name='pause' style='top:7px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                                    onmouseover=\"this.style.backgroundColor='red'\"
                                                    onmouseout=\"this.style.backgroundColor='white'\">Pause</button></div>";
                                            
                                            echo "<div><button type='submit' class='btn btn-primary audio-control play' name='play' data-audio='/audio/nightwemet.mp3' style='left: -80px;top:-25px; position:relative;background-color: white; color: white; padding: 10px 20px; border: none; border-radius: 30px; cursor: pointer; transition: background-color 0.3s; color:#181818;'
                                                    onmouseover=\"this.style.backgroundColor='darkgreen'\"
                                                    onmouseout=\"this.style.backgroundColor='white'\">Play</button></div>";
